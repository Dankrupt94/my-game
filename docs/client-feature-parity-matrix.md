...
| Spells | Planned | Spellbook, cast packets, cooldowns, interrupt/fail messages. | Action bar and spellbook. | Cast a known safe spell and observe result/aura/cooldown. | Must handle target requirements and packet feedback. |
