...
public:
    ...
    godot::Dictionary trainer_list_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t target_entry,
        godot::String const& target_name);
    godot::Dictionary trainer_list_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        godot::String const& target_name);
    godot::Dictionary questgiver_list_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t target_entry,
        godot::String const& target_name);
    godot::Dictionary questgiver_list_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        godot::String const& target_selector,
        godot::String const& target_name);
    godot::Dictionary questgiver_status_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t target_entry,
        godot::String const& target_name);
    godot::Dictionary questgiver_status_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
    ...
    godot::Dictionary questgiver_details_probe_selector(
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary questgiver_accept_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary questgiver_accept_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary quest_abandon_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary quest_abandon_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary quest_reward_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        godot::String const& starter_name,
        godot::String const& reward_target_name);
    godot::Dictionary quest_reward_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        godot::String const& character_name,
        godot::String const& starter_selector,
        godot::String const& reward_target_selector,
        int64_t quest_id,
        int64_t reward_choice,
        godot::String const& starter_name,
        godot::String const& reward_target_name);
    ...
    godot::Dictionary trainer_buy_spell_probe_selector(
        ...
        godot::String const& target_name,
        int64_t spell_id);
    godot::Dictionary vendor_list_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t target_entry,
        godot::String const& target_name);
    godot::Dictionary vendor_list_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
