...
public:
    ...
    godot::Dictionary questgiver_accept_probe_selector(
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary questgiver_reward_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary questgiver_reward_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        int64_t quest_id,
        godot::String const& target_name);
    godot::Dictionary questgiver_turnin_probe(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
        ...
        godot::String const& target_name);
    godot::Dictionary questgiver_turnin_probe_selector(
        godot::String const& host,
        godot::String const& port,
        godot::String const& account,
        godot::String const& password,
